...
1. Select `File > Save as` and save the file by adding your last name at the beginning with an underscore, example: `fout_progress_check_1.rmd`
...
1. Your completed assignment should contain all progress checks from Sections 2.1 and 2.2
